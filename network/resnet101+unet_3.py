...
for i in range(0, 40):
    ...
    if max_score < valid_logs['iou_score']:
        ...
        torch.save(model, '/home/lvweikun/segmentation_models.pytorch/examples/best_model3.pth')
        print('Model saved!')
...
best_model = torch.load('/home/lvweikun/segmentation_models.pytorch/examples/best_model3.pth')
